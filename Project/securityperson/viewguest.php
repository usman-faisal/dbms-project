        ...
        <div class="card-body">
            ...
            <div class="table-responsive">
                ...
                FROM `guest` 
                    ...
                    LEFT JOIN `security_person` ON `guest`.`SP_ID` = `security_person`.`S_ID` where 
                    MONTH(G_ARRIVAL) = MONTH(CURRENT_DATE()) AND YEAR(G_ARRIVAL) = YEAR(CURRENT_DATE()) 
                    and G_TYPE='Normal' order by G_ID DESC";
