...
<ul class="navbar-nav bg-gradient-success sidebar sidebar-dark accordion" id="accordionSidebar">
  ...
  <a class="sidebar-brand d-flex align-items-center justify-content-center" href="index.php">
    ...
    <div class="sidebar-brand-text">Welcome <?php echo $_SESSION["ausername"];?></div>
  </a>
  ...
  <li class="nav-item">
    ...
    <div id="collapseUtilities" class="collapse" aria-labelledby="headingUtilities" data-parent="#accordionSidebar">
      <div class="bg-white py-2 collapse-inner rounded">
        ...
        <a class="collapse-item" href="managepayment.php">View Payment Due</a>
        <a class="collapse-item" href="viewpayment.php">Received Payment</a>
  ...
  <li class="nav-item">
    ...
    <div id="collapsePages" class="collapse" aria-labelledby="headingPages" data-parent="#accordionSidebar">
      <div class="bg-white py-2 collapse-inner rounded">
        ...
        <a class="collapse-item" href="unsolvedcomplaint.php">Un Solved</a>
        <a class="collapse-item" href="inprogresscomplaint.php">In progress</a>
      ...
      <ul class="navbar-nav ml-auto">
        ...
        <li class="nav-item dropdown no-arrow mx-1">
          ...
          <div class="dropdown-list dropdown-menu dropdown-menu-right shadow animated--grow-in" aria-labelledby="alertsDropdown">
            ...
            $sql = "SELECT `member`.*, `house`.*, `payment`.* FROM `member` LEFT JOIN `house` ON `member`.`HOUSE_H_ID` = `house`.`H_ID` 
                        ...
                        MONTH(P_DATE)=MONTH(now()) and YEAR(P_DATE)=YEAR(now()) order by P_DATE DESC limit 5;";
            ...
            ?>
                ...
                <a class="dropdown-item d-flex align-items-center" href="../admin/viewpayment.php">
                  <div class="mr-3">
                  ...
                  ?>
                  <div>
                    <div class="small text-dark-500 font-weight-bold"><?php echo $dateformate; ?></div>
                    <span class="font-weight-bold">
                      <?php

                                                    echo "Payment Amount <b>".$row['P_AMOUNT']."</b> received from House Number <b>".$row['H_NO']."</b>";
                                                    ?></span>
                  </div>
                </a>
            <?php }
        ...
        <li class="nav-item dropdown no-arrow">
          ...
          <div class="dropdown-menu dropdown-menu-right shadow animated--grow-in" aria-labelledby="userDropdown">
            <a class="dropdown-item" href="manageadminprofile.php">
