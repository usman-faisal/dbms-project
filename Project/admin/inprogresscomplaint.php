...
<div class="container-fluid">
    ...
    <div class="card shadow mb-4">
        <div class="card-header py-3">
            <h6 class="m-0 font-weight-bold text-dark">Inprogress Complaints
            </h6>
        </div>
        ...
        <div class="card-body">
            ...
            <div class="table-responsive">
                ...
                //$sql = "SELECT * FROM complaint where C_STATUS='Inprogress' order by C_ID DESC";
                ...
                where complaint.C_STATUS='Inprogress' order by complaint.C_ID DESC";
