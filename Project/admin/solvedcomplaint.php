    ...
    <div class="card shadow mb-4">
        ...
        <div class="card-body">
            ...
            <div class="table-responsive">
                ...
                //$sql = "SELECT * FROM complaint where C_STATUS='Solved' order by C_ID DESC";
                ...
                where MONTH(C_DATE)=MONTH(now()) and YEAR(C_DATE)=YEAR(now()) and complaint.C_STATUS='Solved' order by complaint.C_ID DESC";
                    ...
                    <tbody>
                        ...
                        ?>
                                ...
                                <tr>
                                    ...
                                    <td style="color: green;"><?php echo $row['C_STATUS']; ?> </td>

                                    <!-- <td>
                                <form action="edithouse.php" method="post">

                                    <input type="hidden" name="editid" value="" required>
