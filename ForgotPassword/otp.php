        ...
        <div class="login-box">
            ...
            <div class="row h-100 justify-content-center align-items-center ">
                ...
                <div class="col-md-6 col-sm-6 col-12 login-box-form p-4">
                    ...
                    <!-- <small class="text-muted bc-description">Verify your OTP</small> -->
                    <form action=" Email/email.php" method="post" class="mt-2">
                        <div class="input-group mb-3">
                            <input type="number" class="form-control mt-0" name="otp" placeholder="Enter your OTP" required>
                        </div>


                        <div class="form-group">
                            <input type="submit" class="btn btn-theme btn-block p-2 mb-1" name="verifyotp" value="Verify OTP">
                            <br>
                            <a href="../login.php">
