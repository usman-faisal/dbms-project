    ...
    <div class="login-box">
      ...
      <div class="row h-100 justify-content-center align-items-center ">
        ...
        <div class="col-md-6 col-sm-6 col-12 login-box-form p-4">
          ...
          <small class="text-muted bc-description">Create strong password.</small>
          <br>
          <br>
          <form action="Email/email.php" method="post" class="mt-2">
            <div class="input-group mb-3">
              ...
              <input type="password" class="form-control mt-0" name="pass" placeholder="Create password" required>
            </div>
            ...
            <div class="input-group mb-3">
              ...
              <input type="password" class="form-control mt-0" name="cpass" placeholder="Confirm password" required>
            </div>

            <div class="form-group">
              <input type="submit" class="btn btn-theme btn-block p-2 mb-1" name="newpass" value="Reset Password">
